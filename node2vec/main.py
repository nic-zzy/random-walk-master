...
if __name__ == '__main__':
    ...
    # Step 3: train model
    walks = walker.generate_walks(nodes=[i for i in range(ho_data.num_nodes)], walk_per_node=1,
                                  walk_length=5, p=4, q=0.5)
    ...
    save_flag = False
    if save_flag:
        model.save("../save/Node2Vec_Sg.model")